...
public class StudentController {
    ...
    public String saveStudent(@ModelAttribute("student") StudentDTO student, BindingResult result, ModelMap model ,  @RequestParam(required = false,value = "groupId")  String groupId) {
	...
	public String updateStudent(@RequestParam("id") Long id,
	    ...
	    try {
	    	...
	    	for (Registration registration : registrations) {
	    		if (registration.getStudent().getId() == Updatestudent.getId() && registration.getGroup().getId() == registrationGroup) {
