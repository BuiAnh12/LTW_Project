    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="group.html" class="list-group-item list-group-item-action bg-transparent second-text active"><i
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                ...
                <div>
                    ...
                    <button class="btn-sm btn-success">Addlist</button>
                    <button class="btn-sm btn-success">UploadList</button>
                </div>
                        ...
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" style="width: 150px;">Time of next lesson</th>
                                ...
                                <tr>
                                    <th scope="col" style="width: auto;"><input type="text" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1"></th>
