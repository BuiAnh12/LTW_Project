		...
		<div id="page-content-wrapper">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
						<li class="nav-item dropdown"><span
							...
							aria-expanded="false"> <i class="fas fa-user me-2"></i><%=securityUtil.getPrincipal().getFullName()%>
						</span>
							<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
								<li><a class="dropdown-item"
									href="subpage/userdetail?userid=<%=securityUtil.getPrincipal().getUserId()%>">Profile</a></li>
			...
			<div class="container">
				...
				<div class="row my-2 ">
					...
					<div class="col" id="scheduleTable" style="padding-top: 20px">
						<table class="table-custom">
							<thead>
								...
								<tr>
									...
									<th scope="col"><input type="text" id="nextLesson"
										class="form-control" placeholder="" aria-label="nextLesson"
										aria-describedby="basic-addon1" /></th>
									<th scope="col"><input type="text" id="courseName"
										class="form-control" placeholder="" aria-label="courseName"
										aria-describedby="basic-addon1" /></th>
									<th scope="col"><input type="text" id="groupTitle"
										class="form-control" placeholder="" aria-label="groupTitle"
										aria-describedby="basic-addon1" /></th>
									<th scope="col"><input type="text" id="teacherName"
										class="form-control" placeholder="" aria-label="teacherName"
										aria-describedby="basic-addon1" /></th>
									<th scope="col"><input type="text" id="format"
										class="form-control" placeholder="Format" aria-label="format"
										aria-describedby="basic-addon1" /></th>
							...
							<tbody id="scheduleTable">
								<c:forEach var="schedule" items="${schedules}">
									<tr>
										...
										<td><a href="course/course/${schedule.courseId}.htm">${schedule.courseName}</a></td>
										<td><a href="group/group/${schedule.groupId}.htm">${schedule.groupTitle}
												<br> <small class="small-text">${schedule.groupDetail}</small>
										</a></td>
										<td><a href="teacher/teacher/${schedule.teacherId}.htm">${schedule.teacherName}</a></td>
						...
						<div class="table-footer">
							<c:set var="prefixUrl"
								value="${pageContext.servletContext.contextPath}/category/schedule?page="
								scope="page" />
							<div
								class="d-flex justify-content-center align-items-center w-100">
								<span class="interact-page-btn"> <c:choose>
										<c:when test="${currentPage > 1}">
											<a href="${prefixUrl}${currentPage - 1}"> <i
												class="fa-solid fa-angle-left"></i>
											</a>
										</c:when>
										<c:otherwise>
											<a> <i class="fa-solid fa-angle-left"></i>
											</a>
										</c:otherwise>
									</c:choose>
								</span>
	        ...
	        function inital_cb(start, end) {
	            ...
	            $(
					'#reportrange span').html(
						...
						$(
								'#nextLesson, #courseName, #groupTitle, #teacherName, #format')
