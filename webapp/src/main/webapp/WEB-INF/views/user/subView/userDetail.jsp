...
<body>
						...
						<div class="row">
							...
							<div class="col">
								...
								<div class="row ">
									...
									<div class="col-6">
										<Span class="fw-bold">Role</Span> <select class="form-control"
											aria-label="Role" aria-describedby="basic-addon1"
											name="userRole" data=${userObject.userRole}>
									...
									<div class="col-6">
										<Span class="fw-bold">Offices</Span> <input type="text"
											class="form-control" placeholder="Them cho co"
											aria-label="Username" aria-describedby="basic-addon1"
											disabled="disabled">
									</div>
							...
							<!-- ACCOUNT -->
								...
								<div class="row">
									<div class="col text-center">
										...
										<button type="button" class="custom-button delete-button" onclick="handleDelete(${userObject.userId})">Delete</button>
    ...
    function handleDelete(userid) {
     /*    // URL to send the DELETE request to
        const url = `manager/deleteuser?userId=` + userid;
        console.log(url)
