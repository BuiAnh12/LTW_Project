...
<body>
                        ...
                        <div class="col-6">
                            ...
                            <div class="row ">   
                                <div class="col-6">
                                   ...
                                   <select class="form-control" aria-label="Role" aria-describedby="basic-addon1" name="userRoleId" data="${userObject.useRoleId}" >
	...
	<script>
		// JavaScript function to update userObject.userRoleId when select value changes
		document.getElementById('userRoleId').addEventListener('change',
				function() {
					var selectedValue = this.value;
					// Assign the selected value to userObject.userRoleId
					userObject.userRoleId = selectedValue;
				});
	</script>
</body>
