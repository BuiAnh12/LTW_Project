...
<body>
 ...
 --%>
                    ...
                    <div class="col">
						...
						<form action="/manager/course-list-active-btn" method="POST" id="content_table">
							<table class="table">
								...
								<tbody>
									<c:forEach items="${courseList}" var="course">
										<tr>
											<td><a
												href="${pageContext.servletContext.contextPath}/teachersubpage/details-course?courseId=${course.courseId}">
							...
							<div class="table-footer">
								<c:set var="prefixUrl"
									value="${pageContext.servletContext.contextPath}/teacher/course?page="
									scope="page" />
								<div
	...
	<script type="text/javascript">
        function search() {
            $.ajax({
                url: '${pageContext.servletContext.contextPath}/teacher/course.htm',
                type: 'GET',
                data: {
