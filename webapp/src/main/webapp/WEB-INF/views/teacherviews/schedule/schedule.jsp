        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
                   ...
                   <!-- tableContent -->
                            ...
                            <table class="table bg-white rounded shadow-sm  table-hover">
                                ...
                                <tbody id="scheduleTable">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="teacher/course/course/${schedule.courseId}.htm">${schedule.courseName}</td>
                                        <td><a href="teacher/group/group/${schedule.groupId}.htm">${schedule.groupTitle}
                                        	<br>
                                        	<small class="small-text">${schedule.groupDetail}</small>
                                        </td>
                                        <td><a href="teacher/teacher/teacher/${schedule.teacherId}.htm">${schedule.teacherName}</td>
                    ...
                    <c:set var="prefixUrl" value="${pageContext.servletContext.contextPath}/teacher/schedule?page=" scope="page" />
