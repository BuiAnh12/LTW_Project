...
<body>
       ...
       <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Teacher's Group Details</h2>
                </div>
            ...
            <div class="container">
                <div class="detail_container">
												...
												<div class="row selected_class">
													<div class="col-12">
														<div class="row form-container">
															...
															<span style="font-weight: bold;">GROUP NOTE</span>
															<div class="col-12 form-group">
                    ...
                    <div class="d-flex justify-content-center">
                     <span  style="font-weight: bold; font-size: 24px">STUDENT LIST</span>
    ...
    <!-- Modal content -->
				                        ...
				                        <c:forEach var="student" items="${students}">
										    ...
										    <c:if test="${not isExisted}">
										        <tr data-link="link_to_redirect">
										            <td>
										                <a href="${pageContext.request.contextPath}/teacher/student/detail/${student.id}" style="text-decoration: none; color: rgb(25, 0, 255)">
                    ...
                    <div class="row">
                                                ...
                                                <thead>
													...
													<tbody>
														<c:forEach var="student" items="${studentList}">
															<tr data-link="link_to_redirect">
																<td class="align-middle"><small><a href="${pageContext.request.contextPath}/teacher/student/detail/${student.studentId}"
																...
																<td class="align-middle">
																	<div class="input-group" style="align-items: center;">
																		...
																		<div class="input-group-append">
																			<button disabled="disabled" class="btn-danger delete-btn" style="height: 30px; width: 30px; 
                        ...
                        <div class="divider" style="height: 20px;"></div>
                        <div class="d-flex justify-content-center">
                     <span  style="font-weight: bold; font-size: 24px">LESSION LIST</span>
                     <!--    <input type="button" class="btn-add" style="background-color: rgb(0, 148, 227);"
                            value="Add Student" onclick="openModal()"> -->
                    </div>
													...
													<tbody>
														<c:forEach var="lesson" items="${lessonList}" varStatus="loop">
														    ...
														    <tr data-link="link_to_redirect">
														        <td class="align-middle">
														            <small>
														                <%-- <a href="" class="disabled-link" style="text-decoration: none; color: rgb(0, 191, 255)">
														                    ${lesson.lesson.detail}
														                    
														                </a> --%>
														                <span style="text-decoration: none; color: rgb(0, 191, 255)" >${lesson.lesson.detail}</span>
														            </small>
														        </td>
														        <td class="align-middle">
														            <input type="date" value="${lesson.occurDate}" id="date${loop.index}" disabled="disabled" onchange="handleLessonChange(${loop.index})">
														        </td>
														        <td class="align-middle">
														        ...
														        <td class="align-middle">
														            <div class="form-group">
														                <select class="form-control-sm status-select" id="status${loop.index}" disabled="disabled" onchange="handleLessonChange(${loop.index}) ; updateBackgroundColor('status${loop.index}')" >
														                    <c:choose>
